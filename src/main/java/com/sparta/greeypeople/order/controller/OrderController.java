...
public class OrderController {
    ...
    public ResponseEntity<DataCommonResponse<OrderResponseDto>> createOrder(
        ...
        OrderResponseDto responseDto = orderService.createOrder(storeId, orderRequest,
            userDetails.getUser());
        DataCommonResponse<OrderResponseDto> response = new DataCommonResponse<>(201, "주문 작성 성공",
            responseDto);
    ...
    public ResponseEntity<DataCommonResponse<OrderResponseDto>> getOrder(
        ...
        DataCommonResponse<OrderResponseDto> response = new DataCommonResponse<>(200, "주문 단건 조회 성공",
            order);
    ...
    public ResponseEntity<DataCommonResponse<OrderResponseDto>> updateOrder(
        ...
        OrderResponseDto responseDto = orderService.updateOrdeer(orderId, orderRequestDto,
            userDetails.getUser());
        DataCommonResponse<OrderResponseDto> response = new DataCommonResponse<>(200, "리뷰 수정 성공",
            responseDto);
